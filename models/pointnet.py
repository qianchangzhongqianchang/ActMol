...
class PointNet(nn.Module):
    def __init__(self, num_classes=1, alignment=False):
        ...
        #self.conv2s = Conv1dLayer(
        #    [64, 128, 256], act='relu', norm=False, bias=True)
        ...
        # self.classifier = MLP([512, 512, 256, num_classes],
        #                       act='relu', norm=True, bias=True, dropout=0.5)
        #self.classifier = MLP([256, 512, 256, num_classes],
        #                     act='relu', norm=False, bias=True, dropout=0.5)
